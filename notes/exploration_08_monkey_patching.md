...
- [A.1 메서드 교체/추가 (Monkey Patching)](#a1-메서드-교체추가-monkey-patching)
- [A.2 런타임에 새 메서드/속성 추가](#a2-런타임에-새-메서드속성-추가)
- [A.3 독스트링 동적 변경](#a3-독스트링-동적-변경)
- [A.4 메서드 후크 — 데코레이터의 본질](#a4-메서드-후크--데코레이터의-본질)
- [A.5 상속 구조까지 런타임에 변경](#a5-상속-구조까지-런타임에-변경-극단적)
- [A.6 용어 정리](#a6-용어-정리)
- [A.7 "할 수 있다" ≠ "해야 한다"](#a7-할-수-있다--해야-한다")
- [A.8 다른 언어와 비교](#a8-다른-언어와-비교)
- [A.9 네임스페이스와 C# Partial Class](#a9-네임스페이스와-c-partial-class)
- [A.10 객체→소스 역직렬화](#a10-동적으로-수정한-클래스를-소스-코드로-출력할-수-있나)
