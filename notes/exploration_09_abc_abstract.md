...
> **강제력은 완전히 다르다**.
>
> 📘 `@override` 자체의 일반적 설명(오타 방지, Java/C# 비교 등)은 [exploration_07 C.1.3](./exploration_07_syntax_idioms.md#c13-override--python-312-pep-698) 참조. 이곳에선 abc와의 **강제력 차이**에 집중.
