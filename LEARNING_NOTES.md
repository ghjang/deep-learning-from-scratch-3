...
| # | 시점 | 주제 | 파일 |
|---|---|---|---|
| 1 | step01 직후 | Python 클래스 / NumPy / 프레임워크 기본기 (12가지) | [notes/exploration_01_python_basics.md](./notes/exploration_01_python_basics.md) |
...
- 정답지: `steps/step01.py`
- 🧪 보충 탐구 #1: [notes/exploration_01_python_basics.md](./notes/exploration_01_python_basics.md) (Python/NumPy/프레임워크 기본기 12가지)
