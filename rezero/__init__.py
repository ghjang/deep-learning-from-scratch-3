...
진행 상황:
  - 현재 단계: step30 대기 (3고지 "고차 미분 계산" — 최적화 자동화. 2차 미분 자동 = 고차 미분 본론 시작)
  - 완료한 step: step01 ~ step29 ✅ (+ 뉴턴 방법 수동 계산 — 접하는 포물선의 바닥으로 점프)
"""

__version__ = "0.2.5"  # ★ step29 완료 (뉴턴 방법 수동 계산 — 2차 수렴 실증. PATCH bump)
