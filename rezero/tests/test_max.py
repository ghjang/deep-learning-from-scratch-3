"""
rezero.tests.test_max — [3고지] max 연산의 forward/backward
====================================================

이 파일은 rezero 구현체의 max 연산의 forward/backward 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_max.py 참고):
...
class TestMax(unittest.TestCase):
    """TODO: max 연산의 forward/backward 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_max.py 스타일):
