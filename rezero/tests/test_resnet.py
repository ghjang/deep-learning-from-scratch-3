"""
rezero.tests.test_resnet — [5고지] ResNet 모델 forward
====================================================

이 파일은 rezero 구현체의 ResNet 모델 forward 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_resnet.py 참고):
...
class TestResNet(unittest.TestCase):
    """TODO: ResNet 모델 forward 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_resnet.py 스타일):
