"""
rezero.tests.test_dropout — [4고지] Dropout 정규화
====================================================

이 파일은 rezero 구현체의 Dropout 정규화 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_dropout.py 참고):
...
class TestDropout(unittest.TestCase):
    """TODO: Dropout 정규화 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_dropout.py 스타일):
