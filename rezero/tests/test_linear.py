"""
rezero.tests.test_linear — [4고지] Linear(완전연결) 층
====================================================

이 파일은 rezero 구현체의 Linear(완전연결) 층 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_linear.py 참고):
...
class TestLinear(unittest.TestCase):
    """TODO: Linear(완전연결) 층 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_linear.py 스타일):
