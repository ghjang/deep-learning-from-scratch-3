"""
rezero.tests.test_im2col — [5고지] im2col/col2im 헬퍼
====================================================

이 파일은 rezero 구현체의 im2col/col2im 헬퍼 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_im2col.py 참고):
...
class TestIm2col(unittest.TestCase):
    """TODO: im2col/col2im 헬퍼 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_im2col.py 스타일):
