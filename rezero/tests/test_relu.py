"""
rezero.tests.test_relu — [4고지] ReLU 활성화 함수
====================================================

이 파일은 rezero 구현체의 ReLU 활성화 함수 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_relu.py 참고):
...
class TestRelu(unittest.TestCase):
    """TODO: ReLU 활성화 함수 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_relu.py 스타일):
