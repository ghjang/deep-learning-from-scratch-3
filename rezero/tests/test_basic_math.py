"""
rezero.tests.test_basic_math — [1고지] 사칙연산 (add/sub/mul/div/neg/pow)의 forward/backward
====================================================

이 파일은 rezero 구현체의 사칙연산 (add/sub/mul/div/neg/pow)의 forward/backward 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_basic_math.py 참고):
...
class TestBasicMath(unittest.TestCase):
    """TODO: 사칙연산 (add/sub/mul/div/neg/pow)의 forward/backward 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_basic_math.py 스타일):
