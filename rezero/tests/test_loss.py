"""
rezero.tests.test_loss — [4고지] 손실 함수 (MSE, softmax_cross_entropy)
====================================================

이 파일은 rezero 구현체의 손실 함수 (MSE, softmax_cross_entropy) 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_loss.py 참고):
...
class TestLoss(unittest.TestCase):
    """TODO: 손실 함수 (MSE, softmax_cross_entropy) 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_loss.py 스타일):
