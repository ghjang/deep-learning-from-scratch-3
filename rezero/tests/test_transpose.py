"""
rezero.tests.test_transpose — [3고지] transpose의 forward/backward + 축 지정
====================================================

이 파일은 rezero 구현체의 transpose의 forward/backward + 축 지정 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_transpose.py 참고):
...
class TestTranspose(unittest.TestCase):
    """TODO: transpose의 forward/backward + 축 지정 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_transpose.py 스타일):
