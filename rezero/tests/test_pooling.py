"""
rezero.tests.test_pooling — [5고지] Pooling(최대 풀링) forward/backward
====================================================

이 파일은 rezero 구현체의 Pooling(최대 풀링) forward/backward 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_pooling.py 참고):
...
class TestPooling(unittest.TestCase):
    """TODO: Pooling(최대 풀링) forward/backward 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_pooling.py 스타일):
