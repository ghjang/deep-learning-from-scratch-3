"""
rezero.tests.test_batchnorm — [5고지] BatchNorm 정규화
====================================================

이 파일은 rezero 구현체의 BatchNorm 정규화 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_batchnorm.py 참고):
...
class TestBatchNorm(unittest.TestCase):
    """TODO: BatchNorm 정규화 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_batchnorm.py 스타일):
