"""
rezero.tests.test_sum — [3고지] sum의 forward/backward + axis/keepdims
====================================================

이 파일은 rezero 구현체의 sum의 forward/backward + axis/keepdims 을(를) 검증하는 자리입니다.

패턴 (원본 tests/test_sum.py 참고):
...
class TestSum(unittest.TestCase):
    """TODO: sum의 forward/backward + axis/keepdims 검증 케이스를 여기에 구현하세요.

    예시 (원본 tests/test_sum.py 스타일):
