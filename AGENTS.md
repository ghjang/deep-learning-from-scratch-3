...
> **작업 원칙/체크리스트/절차의 개선이 필요하다고 판단되면, 랩업 등으로 미루지 말고 즉시 반영한다.**

- ✅ "이건 다음에 체크리스트에 추가해야겠다" → **지금 바로 AGENTS.md에 추가**
- ✅ "다음 랩업 때 검토" → **지금 바로 검토**
- ❌ "까먹기 전에 나중에 박아두자" → 까먹을 확률 100%

이유: 미루면 까먹음. 브로가 "나우오러네버"라고 한 것이 정답.
