...
- **진행 중**: 0
- **막힘**: 0
- **마지막 업데이트**: 2026-08-24 — ★★★ step36 완료 = 제 3고지 (step25~36, 고차 미분 계산) 점령! 하루에 step33/34/35/36 4개 완료.
- ★ **다음 작업**: 제 4고지 진입 **전**에 [Issue 43번 — 4고지 진입 전 작업 계획](https://github.com/ghjang/deep-learning-from-scratch-3/issues/43) (후보 회수 + v0 실험 + 개선 수집) — ★ 새 세션은 이 이슈부터 볼 것
