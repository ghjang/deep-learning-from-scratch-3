...
- ★ **다음 작업** (2026-08-28 저녁 갱신 — 새 세션용 인수인계): **① 노트 37(전치·다차원 어드레싱) 브로 정독 + 점검표 37문항 도전** — 작성 완료 + 대화 보강 완료(2026-08-28: concept image, 혼합 진법, 수학자의 전치 정의, 내적 보존 유도, 미분=선형 근사, std::vector·캐스팅=view/reshape, 어드레싱=내적·strides 자유도 / 2026-08-30 정독 중: axis 국어 사전·3D contraction·축 해석 프로토콜·reshape 해부·트리 뷰(브로 아이디어 — 당기기 규약·포함 관계 포함)·두 클럽 정리, 문항 30→37), 브로가 읽고 답하는 단계. ② [이슈 49 — fill_grad 이름 확정](https://github.com/ghjang/deep-learning-from-scratch-3/issues/49) (4고지 전 타이밍 중요). ③ [이슈 45](https://github.com/ghjang/deep-learning-from-scratch-3/issues/45) 다층 그래프 도구 → [이슈 48](https://github.com/ghjang/deep-learning-from-scratch-3/issues/48) Hessian 실험 → 후보 12(미분 그래프 4종) — 이 3건 세트로 하면 시너지. ④ [이슈 46](https://github.com/ghjang/deep-learning-from-scratch-3/issues/46) 던더 믹스인. ⑤ [이슈 47](https://github.com/ghjang/deep-learning-from-scratch-3/issues/47) MatMul 이중 구현 (step41 시점). ⑥ 작업 3(v0) or 5(연습문제) — 브로 선택. ★ 완료: 이슈 43 작업 1~4 전부 종결 (노트 34/35/36/37, UML 7종, gradient check, 유형 지도). [Issue 43](https://github.com/ghjang/deep-learning-from-scratch-3/issues/43) / [Issue 44](https://github.com/ghjang/deep-learning-from-scratch-3/issues/44)
