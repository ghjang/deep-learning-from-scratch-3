...
- ★ **다음 작업**: 이슈 43 작업 **4번부터** (v1/v2 리팩터링 검토 → 3번 v0 실험 → 5번 연습 문제) — 작업 1+2(야코비안/VJP 탐구)는 2026-08-24 완료, [탐구 노트 34](./notes/exploration_34_jacobian_vjp.md)로 승격. [Issue 43번 — 4고지 진입 전 작업 계획](https://github.com/ghjang/deep-learning-from-scratch-3/issues/43) — ★ 새 세션은 이 이슈부터 볼 것
